...
export const emails = {
	...
	account: {
		deleted: 'Your Expense-Tracker account is Deleted!',
	},
	welcome: {
	...
	from: 'Gokul from Expense-Tracker <hello@Expense-Tracker>',
	signin: { subject: 'Sign in link for Expense-Tracker' },
	signup: { subject: 'Sign up link for Expense-Tracker' },
};
